...
import type { AIConnectionTestResult, AIModelCapabilities, AIProviderProfile, AIRoutingMode, AISettingsSnapshot as SharedAISettingsSnapshot, AITaskType, CreateAIProviderInput, UpdateAIRoutingInput } from "@/domain/ai-config/contracts";
