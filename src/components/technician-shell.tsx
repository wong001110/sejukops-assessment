...
export function TechnicianShell({ identityId, children }: { identityId: string; children: ReactNode }) {
  ...
  return <main className="technician-shell">
    ...
    <div className="technician-role-bar" style={{ display: "grid", gridTemplateColumns: "minmax(0, 1fr)", gap: 6 }}>
      <span className="technician-role-caption">Demo identity</span>
      <RoleSwitcher currentIdentityId={identityId} fluid />
    </div>
